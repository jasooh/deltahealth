...
import IllnessDataPage from '@/components/IllnessDataPage';
    ...
    return (
        <div className="min-h-screen bg-background">
          <div className="container mx-auto p-8">
            <h1 className="text-center text-5xl font-bold text-primary mb-8">Illness Catalogue</h1>
            ...
            <div className="flex flex-col gap-8 items-center">
              {filteredIllnesses.map((illness, index) => (
                <div
                  key={index}
                  className="bg-card text-text p-6 rounded-lg shadow-lg border-2 border-gray-500 w-1/2"
                >
